# The IPDB Transaction Spec, Version 1.0
...
Note: IPDB is short for Interplanetary Database.
...
Note: This version of the IPDB Transaction Spec conforms to versions 02 and 03 of the crypto-conditions spec. (The parts that it uses didn’t change from version 02 to 03.)
...
The final result (`final_tx`) is a valid fulfilled transaction (in the form of an associative array). To put it in the body of an HTTP POST request, you’ll have to <a href="#json-serialization"><span>convert it to a JSON string</span></a>.
